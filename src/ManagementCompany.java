...
public class ManagementCompany {
	...
	public int addProperty(Property property) {
		if(property == null) {
			...
			System.out.println("in AddProperty. plot = " + plot);
			System.out.println("property = " + property);
			System.out.println("property.plot = " + property.plot);
			if (!plot.encompasses(property.plot)) {
				...
				for(int n =0; n <properties.length; n++) {
					...
					else if (properties[n].plot.overlaps(property.plot)) {
						return -4;
					}
				}
			}
	...
	public String maxPropertyRent() {
		int index = maxPropertyRentIndex();
		System.out.println("index = " + index);
		System.out.println("properties[index] = " + properties[index]);
		return properties[maxPropertyRentIndex()].toString();
	}
	public int maxPropertyRentIndex() {
		double rent = 0;
		int indexValue = 0;
		for (int n = 0; n < properties.length && properties[n] !=null; n++) {
...
//				System.out.println("TEST" + n);
	...
	public double maxRentProp() {
		...
		System.out.println("index = " + index);
		System.out.println("properties[index] = " + properties[index]);
		return properties[maxPropertyRentIndex()].getRentAmount();
	}
